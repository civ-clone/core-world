...
describe('Tile', (): void => {
  ...
  it('should return expected distances for other `Tile`s', (done): void => {
  ...
  it('should correctly wrap when checking distances', (done): void => {
    generateWorld().then((world) => {
      const tile = world.get(0, 0);
  ...
  it('should correctly return neighbouring tiles', (done): void => {
    generateWorld().then((world) => {
      const tile = world.get(0, 0);
  ...
  it('should be able to identify the underlying terrain', (done): void => {
    generateTile().then((tile) => {
  ...
  it('should correctly calculate score', (done): void => {
    generateTile(ruleRegistry).then((tile) => {
      expect(
        tile.score(
  ...
  it('should cache yields for a player', (done): void => {
    generateTile(ruleRegistry).then((tile) => {
  ...
  it('should correctly identify and return surrounding tiles', (done): void => {
    generateWorld().then((world) => {
      const tile = world.get(0, 0);
  ...
  it('should correctly identify coastal tiles', (done): void => {
    generateWorld(generateGenerator(10, 10, Land)).then((world) => {
      const tile = world.get(0, 0);
