import { EntityRegistry, IEntityRegistry } from '@civ-clone/core-registry/EntityRegistry';
...
export declare class LandMassRegistry extends EntityRegistry<LandMass> implements ILandMassRegistry {
    constructor();
    getByTile(tile: Tile): LandMass | null;
}
