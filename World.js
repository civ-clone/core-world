...
var _World_generator, _World_height, _World_ruleRegistry, _World_tiles, _World_width;
...
class World extends DataObject_1.DataObject {
    constructor(generator, ruleRegistry = RuleRegistry_1.instance) {
        super();
...
exports.World = World;
_World_generator = new WeakMap(), _World_height = new WeakMap(), _World_ruleRegistry = new WeakMap(), _World_tiles = new WeakMap(), _World_width = new WeakMap();
